import type { Member, CalendarEvent, PlanItem } from '../types';
...
export const mockCalendarEvents: CalendarEvent[] = [
  {
    ...
    endTime: '10.45',
    color: 'pink',
    assignedTo: mockMembers[1], // Wade Warren
  },
  {
    id: 'e2',
    title: 'Team Meeting',
    ...
    endTime: '12.00',
    color: 'yellow',
    assignedMembers: [mockMembers[0], mockMembers[2], mockMembers[3]],
    extraCount: 3,
  },
  {
    id: 'e3',
    title: 'Design Review on...',
    startTime: '13.00',
    endTime: '13.30',
    color: 'blue',
    assignedTo: mockMembers[2], // Leslie Alexander
  },
];
